...
**To Search Specific Cuisine Types in a Particular City:**
In the search boxes just enter a city name and a cuisine type and then press the search button.
Then the application looks at YELP API database and returns an unordered list of
restaurants serving the specified cuisine in that particular city. Each list item contains a
restaurant name, its ratings, and its address. If the users would like to view details of any
restaurant, they can click on the restaurant name and the application will display full
detail of that restaurant such as its name, ratings, phone number, menue photos, operating hours
and etc. Or the user can view the restaurant on Yelp website/application by clicking on the provided link.

**2. Weather Forecast Sidebar:**
When searching a cuisine type in a particular city, the weather forecast feature displays
...
The application has a favorite-list sidebar. Users can save a restaurant in their favorite
list for the future references which functions as a bucket list. The favorite-list stores the required restaurant
